...
const Card = ({ title, children, headerBackgroundColor, titleColor, width, height, borderColor, position, onDragStart }) => {
    return (
        ...
        <div className="chatbot_card" style={{
            ...
            <div className='chatbot_card_header' style={{ backgroundColor: headerBackgroundColor }}>
                ...
                <button className='chatbot_menu_button'>
...
// const ConditionModal = ({ show, onClose}) => {
...
//                             <div>
//                             <div className='set_condition_container'>
//                             <Autocomplete
//                                 options={options}
//                                 value={content}
//                                 disableClearable
...
//                                 open={open} 
//                 onOpen={() => setOpen(true)} // Set state when dropdown opens
...
//                             />
//                             </div>
//                             <button className='footer__cancel__btn condition__add'>+ Add</button>
//                             </div>
//                         <div className='edit__text__save'>
//                             <button className='footer__cancel__btn'>Cancel</button>
//                             <button className='btn btn-success condition__save'  >Save</button>
//                         </div>
//                     </ModalBody>
//                 </div>
//             </Modal>
...
const EditChatbotPage = () => {
    ...
    //     setCardContent((prev) => [...prev, content]);
    // };
    // const handleClick = (title, content, color,titleColor,width,height,borderColor) => {

    //     if (content) {
    //         const newCard = {
    //             id: Date.now(), 
    //             component: (
    //                 <Card title={title} headerBackgroundColor={color} titleColor={titleColor} width={width} height={height}borderColor={borderColor} >
    //                     {content}
    //                 </Card>
    //             ),
    //         };
    ...
    return (
        <>
            ...
            }
            {
                ...
                <updateAttributeModal show={updateAttributeModal} onClose={handleCloseUpdateModal} onSave={handleSaveUpdate}/>
            }
            <div className='editchatbot_container'>

                <div className='editchatbot_left_container'>
                                ...
                                (
                                    <>
                                        ...
                                        <EditNavContent svg={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" height="26" width="26">
                                            ...
                                            onClick={() => handleClick(
                                                "Question",
                                                <div className='condition_text' onClick={handleQuestion} style={{ color: 'white' }}>question</div>,
                                                '#ff9933',
                                                'white'
                                        ...
                                        <EditNavContent svg={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" height="26" width="26">
                                            ...
                                            onClick={() => handleClick(
                                                ...
                                                <div >
                                                    ...
                                                    <div className='buttons_card' onClick={handleButtons}>
                                        ...
                                        <EditNavContent svg={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" height="26" width="26">
                                            ...
                                            onClick={() => handleClick(
                                                ...
                                                <div >
                                                    <div className='condition_text'>
                                                        default body </div>
                                                    <div className='buttons_card' onClick={handleList}>
                                ...
                                (
                                    <>
                                        <EditNavContent svg={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" height="26" width="26">
                                            ...
                                            onClick={() => handleClick(
                                                ...
                                                <div>
                                                    ...
                                                    <div className='choose_msg_list'>
                                                        <button className='footer__cancel__btn choose_msg_btn'>Message</button>
                                                        <button className='footer__cancel__btn choose_msg_btn'>Image</button>
                                                        <button className='footer__cancel__btn choose_msg_btn'>Video</button>
                                                        <button className='footer__cancel__btn choose_msg_btn'>Audio</button>
                                                        <button className='footer__cancel__btn choose_msg_btn'>Document</button>
                                                    </div> */}
                                        ...
                                        <EditNavContent svg={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" height="26" width="26">
                                            ...
                                            onClick={() => handleClick(
                                                "Set a condition",
                                                <div className='condition_text' onClick={handleConditionComponent}>
                ...
                {showEditChatbot ? (
                    ...
                    <div className='msgCont'>
                        ...
                        <div className='msgContL automation__left__content'>
                            ...
                            <li ><a href='#' onClick={(e) => handleNavigationClick(e, 'keywordaction')}><svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><g id="_2_Keyword_Action" data-name="2_Keyword Action"><path d="M29,35H7a6,6,0,0,1-6-6V7A6,6,0,0,1,7,1H29a6,6,0,0,1,6,6V29A6,6,0,0,1,29,35ZM7,3A4,4,0,0,0,3,7V29a4,4,0,0,0,4,4H29a4,4,0,0,0,4-4V7a4,4,0,0,0-4-4Z" fill="#777" /><path d="M26.36,17h-8a5.66,5.66,0,1,0,0,2h3.27v3.66a1,1,0,0,0,2,0V19h2.7a.47.47,0,0,1,.47.47v3.19a1,1,0,0,0,2,0V19.47A2.48,2.48,0,0,0,26.36,17ZM12.83,21.66A3.66,3.66,0,1,1,16.49,18,3.66,3.66,0,0,1,12.83,21.66Z" fill="#777" /></g></svg><span className='leftbar__item__title'>Keyword Action</span></a></li>
