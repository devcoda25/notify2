...
import { Table, TableBody, TableCell, TableHead, TablePagination, TableRow, IconButton, Tooltip ,  TextField,  MenuItem,Select,Checkbox } from '@mui/material';
...
const AddContactModal = ({ show, onClose, onSave }) => {
    ...
    return (
        <Modal show={show} onHide={onClose} dialogClassName="contact-modal"> 
...
const FilterContactModal=({show, onClose}) => {
    ...
    return(
        <Modal show={show} onHide={onClose} dialogClassName="filter-popup">  
                    ...
                    <Table  className='contact__table '>
                        <TableHead>
                            ...
                            <Checkbox 
                                ...
                                disableRipple
                                        ...
                                        checkedIcon={
                                            <div className="custom-checkbox-input selected">
                                                <input type="checkbox" className="hidden-input" checked />
                                            </div>
                                        }
                            />
                            </TableCell>
                        ...
                        <TableBody>
                            ...
                            <TableRow key={row.id} className='contact__body'>
                                ...
                                <TableCell> 
                                    {Array.isArray(row.attributes) ? row.attributes.map((attr, index) => ( 
                                        <div key={index}>{attr.key}: {attr.value}</div> )) : "No attributes available"
                                    }
                                    </TableCell>
                                <TableCell>
