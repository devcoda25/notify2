                            ...
                            selectedOption === 'user' ? (
                                ...
                                <>
                                    <Table className='usermanagement_table'>
                                        <TableHead className='usermanagement_head'>
                                            <TableRow className='usermanagement__row'>
                                                <TableCell className='usermanagement__cell alignleft firstcell' style={{ width: '10%' }} >
                                                ...
                                                <TableCell className='usermanagement__cell alignleft' style={{ width: '40%' }}>Team Name</TableCell>
                                                <TableCell className='usermanagement__cell' style={{ width: '20%' }}>Default Name
                                                    <Tooltip
                                                        title={
                                                            <ul >
                                                ...
                                                <TableCell className='usermanagement__cell' style={{ width: '10%' }}>Team Size</TableCell>
                                                <TableCell className='usermanagement__cell lastcell' style={{ width: '10%'}}>
                                        ...
                                        <TableBody className='usermanagement__table__body'>
                                            {filterTeamData.map((data, index) => (
                                                <TableRow key={index} className='body_row'>
                                                    ...
                                                    <TableCell className='body__cell alignleft' >{data.teamName}</TableCell>
