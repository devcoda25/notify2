...
export { default as DialPad }           from './DialPad';           // keep if you still use it elsewhere
...
export { default as IconButtonAnimated } from './IconButtonAnimated';
export { default as ShimmerGlitch }     from './ShimmerGlitch';
export { default as DialerLogPanel }        from './DialerLogPanel';