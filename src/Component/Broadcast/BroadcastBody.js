        ...
        <div className='msgContR'>
                        ...
                        <div className="popup-content">
                            ...
                            <form action="/action_page.php" className="attributesForm">
                                ...
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="DRAFT" name="DRAFT" value="DRAFT" onChange={handleCheckboxChange}/>
                                  <label for="DRAFT"> DRAFT </label>
                                </div>
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="PENDING" name="PENDING" value="PENDING" onChange={handleCheckboxChange}/>
                                  <label for="PENDING"> PENDING </label>
                                </div>
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="APPROVED" name="APPROVED" value="APPROVED" onChange={handleCheckboxChange}/>
                                  <label for="APPROVED"> APPROVED</label>
                                </div>
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="REJECTED" name="REJECTED" value="REJECTED" onChange={handleCheckboxChange}/>
                                  <label for="REJECTED"> REJECTED </label>
                                </div>
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="DELETED" name="DELETED" value="DELETED" onChange={handleCheckboxChange}/>
                                  <label for="DELETED"> DELETED </label>
                                </div>
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="PAUSED" name="PAUSED" value="PAUSED" onChange={handleCheckboxChange}/>
                                  <label for="vehicle2"> PAUSED </label>
                                </div>
                                <div className="popupFilterInput">
                                  <input className="popupInputFilter" type="checkbox" id="DIASBLED" name="DIASBLED" value="DIASBLED" onChange={handleCheckboxChange}/>
          ...
          <div>
            <div className="table">
              <table>
                ...
                {DataJsonFile.data.map((datamap)=>{
                  ...
                  return  <tr className="tableTemplateNameTr">
                  <td className="tableTemplateTd"><span>{templateName}</span></td>
                  <td>{Category}</td>
                  <td><button className="statusBtn">{Status}</button></td>
                  <td>{Language}</td>
                  <td>{lastUpdated}</td>
                  <td className="action"><button className="actionBtn">{Actions}</button><hr className="tableTemplateNameHr"/><span className="actionSpanCopy"><div 
            ...
            <div className="bodyFooter">
              ...
              <div>
                <p><CgArrowLongLeft /> <span className="footerPrevious">Previous</span></p>
              </div>
              <div>
                <p className="footerCenter"><span className="footerNext">Next</span> <CgArrowLongRight /></p>
              </div>
          </div>
          </div>
        </div>
