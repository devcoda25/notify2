          ...
          <div>
            <div className="table">
              <table>
               ...
               {/* {dataPush} */}
               {DataJsonFile.data.slice((pageNum-1)*selectNumber,selectNumber*pageNum).map((val, key)=>{return(
                  ...
                  <td className="action"><button className="actionBtn">{val.Actions}</button><hr className="tableTemplateNameHr"/><span  className="actionSpanCopy"><div 
                            className={`${copyIconHover == key ? "icon-popup" : null}`}
                            // className="icon-container"
                            onMouseEnter={() => setIsHovered(true)}
                            onMouseLeave={() => setIsHovered(false)}
                          >
                            <svg className="copy-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.66406 3.33341V13.3334C6.66406 13.7754 6.83966 14.1994 7.15222 14.5119C7.46478 14.8245 7.8887 15.0001 8.33073 15.0001H14.9974C15.4394 15.0001 15.8633 14.8245 16.1759 14.5119C16.4885 14.1994 16.6641 13.7754 16.6641 13.3334V6.03508C16.664 5.81305 16.6196 5.59326 16.5335 5.38862C16.4473 5.18398 16.3212 4.99862 16.1624 4.84341L13.3999 2.14175C13.0885 1.8373 12.6704 1.6668 12.2349 1.66675H8.33073C7.8887 1.66675 7.46478 1.84234 7.15222 2.1549C6.83966 2.46746 6.66406 2.89139 6.66406 3.33341V3.33341Z" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" className='copyIconHover'></path><path d="M13.332 15.0002V16.6668C13.332 17.1089 13.1564 17.5328 12.8439 17.8453C12.5313 18.1579 12.1074 18.3335 11.6654 18.3335H4.9987C4.55667 18.3335 4.13275 18.1579 3.82019 17.8453C3.50763 17.5328 3.33203 17.1089 3.33203 16.6668V7.50016C3.33203 7.05814 3.50763 6.63421 3.82019 6.32165C4.13275 6.00909 4.55667 5.8335 4.9987 5.8335H6.66536" stroke="#333333" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" className='copyIconHover'></path></svg>
                            {isHovered && (
            ...
            <div className="bodyFooter">
              ...
              {!selectCount ?  <div onClick={()=>{setSelectCount(!selectCount)}} class="MuiInputBase-root MuiInputBase-colorPrimary MuiTablePagination-input css-rmmij8"><div tabindex="0" role="combobox" aria-controls=":r5:" aria-expanded="false" aria-haspopup="listbox" aria-labelledby=":r4: :r3:" id=":r3:" class="MuiSelect-select MuiTablePagination-select MuiSelect-standard MuiInputBase-input css-1cccqvr">{selectNumber}</div><input aria-invalid="false" aria-hidden="true" tabindex="-1" class="MuiSelect-nativeInput css-1k3x8v3" value={selectNumber}/><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium MuiSelect-icon MuiTablePagination-selectIcon MuiSelect-iconStandard css-1utq5rl" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ArrowDropDownIcon"><path d="M7 10l5 5 5-5z"></path></svg></div>: null}
             

              <div class="MuiPaper-root MuiPaper-elevation8 MuiPopover-paper MuiMenu-paper MuiMenu-paper css-pwxzbm" tabindex="-1" style={{opacity:'1', transform:'none', minWidth:'48px', transition:'opacity 262ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, transform 174ms cubic-bezier(0.4, 0, 0.2, 1) 0ms;', top:'156px', left:'982px', transformOrigin:'24px 87.7969px',display:selectCount?"block":"none"}}>
                  <ul class="MuiList-root MuiList-padding MuiMenu-list css-r8u8y9" role="listbox" tabindex="-1" aria-labelledby="menu-label" id="menu-list">
                      <li onClick={()=>{
                        setSelectCount(!selectCount)
                        setSelectNumber(5)
                      }} class="MuiButtonBase-root MuiMenuItem-root MuiMenuItem-gutters Mui-selected MuiTablePagination-menuItem css-1gs62wq" tabindex="0" role="option" aria-selected="true" data-value="5">5
                          <span class="MuiTouchRipple-root css-w0pj6f"></span>
                      </li>
                      <li class="MuiButtonBase-root MuiMenuItem-root MuiMenuItem-gutters MuiTablePagination-menuItem css-1gs62wq" tabindex="-1" role="option" aria-selected="false" data-value="10" onClick={()=>{
                         setSelectCount(!selectCount)
                         setSelectNumber(10)
                      }}>10
                          <span class="MuiTouchRipple-root css-w0pj6f"></span>
                      </li>
                      <li class="MuiButtonBase-root MuiMenuItem-root MuiMenuItem-gutters MuiTablePagination-menuItem css-1gs62wq" tabindex="-1" role="option" aria-selected="false" data-value="25" onClick={()=>{
                           setSelectCount(!selectCount)
                           setSelectNumber(25)
                      }}>25
                          <span class="MuiTouchRipple-root css-w0pj6f"></span>
                      </li>
                      <li class="MuiButtonBase-root MuiMenuItem-root MuiMenuItem-gutters MuiTablePagination-menuItem css-1gs62wq" tabindex="-1" role="option" aria-selected="false" data-value="100" onClick={()=>{
                         setSelectCount(!selectCount)
                         setSelectNumber(100)
                      }}>100
                          <span class="MuiTouchRipple-root css-w0pj6f"></span>
