            ...
            <div className='feedbackgeneration_container' >
                <div className='header_content'>
                    <div className='header_left_content' onClick={onClose}>
                        <ArrowBackIcon />
                        <ButtonComponent label='Feedback form' customBtn='generation_backbutton' />
                    </div>
                    ...
                    <div className='content_container'>
                        ...
                        <div className='text_content_container'>
                            ...
                            <div className='textbox_field_content'>
                                <TextfieldComponent type='text' placeholder='Feedback' customStyle='generation_textbox_field' />
                            </div>
                        </div>
                        <div className='textbox_container'>
                            <div className='textbox_title textbox_heading'>Large Heading</div>
                            <div className='textbox_field_content'>
                                <textarea className='generation_textarea_field'>Would you recommend us to a friend?</textarea>
                            </div>
                        </div>
                        <div className='textbox_container'>
                            ...
                            <div className='textbox_field_content'>
                                <TextfieldComponent type='text' placeholder='Choose' customStyle='generation_textbox_field' />
                            </div>
                            <div className='textbox_field_content'>
                                <TextfieldComponent type='text' placeholder='Yes' customStyle='generation_textbox_field' />
                            </div>
                            <div className='textbox_field_content'>
                                <TextfieldComponent type='text' placeholder='No' customStyle='generation_textbox_field' />
                            </div>
                        </div>
                        <div className='textbox_container'>
                            ...
                            <div className='textbox_field_content'>
                                <TextfieldComponent type='text' placeholder='Leave a comment' customStyle='generation_textbox_field' />
                            </div>
                        </div>
                        <div className='text_content_container'>
                            ...
                            <div className='preview_container_second_layer'>
                                <div>
                                    ...
                                    <div className='preview_main_content'>
                                        ...
                                        <div>
                                            <textarea className='generation_preview_textarea_field'>Leave a comment(Optional)</textarea>
                                            <div className='preview_text_counter'>0/600</div>
                                        </div>
                                    </div>
                                </div>
                                <ButtonComponent label='Submit' customBtn='generation_preview_signupbtn' />
