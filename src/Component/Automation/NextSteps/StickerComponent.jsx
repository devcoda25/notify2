...
import {DeleteOutlineIcon,FileDownloadOutlinedIcon} from '../../Icon';
                                    ...
                                    <div key={index} className='material__action__cards'>
                                        <div className='action__edit'>
                                            <div className='action__edit__check'>
                                                {showCheckboxes && (
                                                       <CheckboxComponent
                                                       checked={isMaterialChecked['Sticker']?.includes(data.title)}
                                                       onToggle={() => handleCheckboxToggle(data.title, 'Sticker')}
                                                   />
