import { layoutDagre, layoutElkRadial, layoutNaiveGrid } from './algorithms.js'
import { alignToGrid, translateToPositive } from './utils.js'
...
self.onmessage = async (ev) => {
  ...
  try {
    ...
    const err = { type: 'layout:error', runId: msg.runId, message: e?.message || String(e) }
