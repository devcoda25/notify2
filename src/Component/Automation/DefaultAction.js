...
const DefaultAction = () => {
    ...
    return (
        <>
            ...
            {
                state.showModal && (<Workinghourssettings show={state.showModal} handleClose={handleCloseModal} />)
            }
            {/* current plan modal */}
            {
                state.showCurrentplanModal && (
                    <Modal show={state.showCurrentplanModal} dialogClassName="currentplanmodal">
                        <div className='currentplanmodal-content'>
                            <Modal.Header className='currentplanmodal-header'>
                                <Modal.Title > <CloseIcon onClick={handleCheckboxCloseModal} className='modal-close-btn' /> </Modal.Title>
                            </Modal.Header>
                            <ModalBody>
                                ...
                                <div class="footer__btn__container">
                                    <ButtonComponent label='cancel' onClick={handleCheckboxCloseModal} customBtn='cancel_button_style' />
            ...
            <div className='defaultaction__right__content'>
                ...
                <div className='defaultbodycontent'>
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='grid-working-item'>
                        ...
                        {/* <button className='btn btn-success'>Set Working Hours</button> */}
                    ...
                    <div className='form-select-group'>
                        <div className='select-left-content'>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid'>
                                <CheckboxComponent checked={state.checkbox1}
                                    onToggle={(checked) => handleCheckboxChange('checkbox1', checked)}
                                />
                                <div className='check-label'>When it is not working hours, reply the following</div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={style.defaultActionGrid}>

                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!state.checkbox1} />
                            </Grid>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                ...
                                <div className='check-label'>When there is no customer service online during working hours, reply the following</div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={style.defaultActionGrid}>

                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!state.checkbox2} />
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                ...
                                <div className='check-label'>Send the following welcome message when a new chat is started and no keyword search criteria is met</div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={style.defaultActionGrid}>

                                <Dropdown options={groupedOptions} selectLabel='intro_welcome' disabled={!state.checkbox3} />
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                ...
                                <div className='check-label'>During working hours, users wait more than 2 minutes without any reply and no keyword matched, reply the following</div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={style.defaultActionGrid}>

                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!state.checkbox4} />
                        ...
                        <div className='select-right-content'>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid'>
                                ...
                                <div className='check-label'>Send the following fallback message if no keyword search criteria is met and no default action criteria is met.</div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={style.defaultActionGrid}>

                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!state.checkbox5} />
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                ...
                                />
                                <div className='check-label'>If customer does not respond and it's not SOLVED, when it almost reaches 24 hours since last message, use the following reply</div>
                            </Grid>
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={style.defaultActionGrid}>

                                <Dropdown options={groupedOptions} selectLabel='Soon_to_be_closed' disabled={!state.checkbox6} />
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                ...
                                <div className='check-label'>Expired or Closed chat will not be assigned to Bot but leave the last assignee in case of new message</div>
                            </Grid>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                ...
                                <div className='check-label'>During out of office, send out of office message always (even if a keyword match is found).</div>
                            </Grid>

                            {/* 5th checkbox content */}
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className='checkbox-grid-style'>
                                <CheckboxComponent
                                    onToggle={handleCheckboxModal} />
                                <div className='check-label'>Assign newly opened chats in round robin manner within users of the assigned team
                                </div>
                            </Grid>
                        </div>
                    </div>
