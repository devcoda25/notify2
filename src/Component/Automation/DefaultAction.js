...
import { TextField, Accordion, AccordionSummary, AccordionDetails, List, ListItem, InputAdornment, Autocomplete, ListSubheader, IconButton, MenuItem, Typography } from "@mui/material";
                ...
                <div className='defaultbodycontent'>
                    ...
                    <div className='form-select-group'>
                        <div className='select-left-content'>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={styles.gridDropdown}>
                             
                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!checkbox1Checked}/>
                            </Grid>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={styles.gridDropdown}>
                                ...
                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!checkbox2Checked}/>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={styles.gridDropdown}>
                                ...
                                <Dropdown options={groupedOptions} selectLabel='intro_welcome' disabled={!checkbox3Checked} />
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={styles.gridDropdown}>
                                ...
                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!checkbox4Checked} />
                        ...
                        <div className='select-right-content'>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={styles.gridDropdown}>
                                ...
                                <Dropdown options={groupedOptions} selectLabel='Select material' disabled={!checkbox5Checked}/>
                            ...
                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={styles.gridDropdown}>
                                ...
                                <Dropdown options={groupedOptions} selectLabel='Soon_to_be_closed' disabled={!checkbox6Checked} />
