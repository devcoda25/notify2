...
const eventOptions = [
    ...
    { icon: <LocalPhoneOutlinedIcon />, label: "Phone call", value: 'phone' },
...
const eventLocation = [
    ...
    },
    {
        ...
        value: "custom",
        icon: (
            <svg className="event_customsvg" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg" role="img">
                <path
                    d="M5.5 3.25H9a.5.5 0 0 1 .5.5v2.5a.5.5 0 0 1-.5.5H5.5M1.5 6.75H1a.5.5 0 0 1-.5-.5v-2.5a.5.5 0 0 1 .5-.5h.5M2.5 1.25h2M2.5 8.75h2M3.5 1.25v7.5"
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
        ...
        <div className="select_event_location">
            ...
            <div className="event_container">
                {eventOptions.map((option, index) => (
                    <div key={index} className="select_event_content" onClick={() => {
                        if (option.value === 'zoom') {
                            onSelect({
                                value: option.value,
                                label: option.label,
                                icon: option.selectIcon
                            });
                        } else {
            ...
            {showOptions && (
                <div className="new_meeting_option_menu">
                    {eventLocation.map((option, index) => (
                        <div key={index} className="option_content" 
                        onClick={() => {
                            if (option.value === 'ask') {
                                onSelect(option);
                            } else {
                    ...
                    {showWebConfOptions && (
                        <>
                            ...
                            {webConfOptions.map((option, index) => (
                                <div
                                    key={index}
