...
import { Tabs, Tab, Box, Typography, Button, ToggleButton, ToggleButtonGroup, Dialog, DialogActions, DialogContent, DialogTitle } from "@mui/material";
  ...
  return (
    <div className="calendar_availability">
      ...
      <Box >
          ...
          <>
            <div className="scedule_container">
              ...
              <div className="scedule_btn_container">
                ...
                <Button variant="text" className="createscedule_btn">+ Create schedule</Button>
              </div>
        ...
        {tabIndex === 1 && (
          <Typography variant="h6">Holidays Content</Typography>
        )}
      </Box>
