        ...
        <div className="modal-content">
          ...
          <div className='bodyPoppup'>
            ...
            <div className='bodyPoppupR'>
              ...
              {(marketingTemplate==="whatsapp" && (mobileDeskview==='mobile' || mobileDeskview==='desktop'))?<> <div>
                <img 
                  src={mobileDeskview === 'mobile' ? whatsapp : whatsappDesk} 
                  alt='whatsappImg' 
                  className={mobileDeskview === 'mobile' ? "selectImg" : "selectDeskWhatsapp"} 
                />
              </div> 
              <div className='MobileScroll'>
                {mobileDeskview==='mobile' ?
                 ...
                 : null}
                  <div className={mobileDeskview==='mobile'?'MobileScreen':'DeskScreen'}>
              ...
              {(marketingTemplate==="platform" && (mobileDeskview==='mobile' || mobileDeskview==='desktop'))?<> <div>
                <img 
                  ...
                  alt='platformImg' 
                  className={mobileDeskview == 'mobile' ? 'selectImgs' : 'selectDeskWhatsapp'}/>
              </div> 
              <div className={mobileDeskview=='mobile'?'MobileScroll':'MobileScrollDesk'}>
                  <div className={mobileDeskview=='mobile'?'MobileScreenSms':'MobileScreenSmsDesk'}>
                    <div className={mobileDeskview == 'mobile'?'previewStylePlatform':'previewStylePlatformDesk'}>
              ...
              <div>
                  <div className={mobileDeskview=='mobile'?'MobileScreenPush':'DeskScreenPush'}>
                    <div className={mobileDeskview=='mobile'?'previewStylePush':'previewStylePushDesk'}>
                      { broadcast.value ==="media"&&selectOption === 'IMAGE' ? <div className='bg-img-div'>
                      <img src={filePreview ? filePreview:img} alt="Image" className="documentVdoImg"/>
                      </div> :null} 
              ...
              <div className='MobileScroll'>
                  <div className={mobileDeskview == 'mobile'? 'MobileScreenSms': 'DeskScreenSms'}>
                    <div>
                      <div className='previewEmailTitle'>
                        {htmlText ? <div
                          className="previewTextStyle" 
                          dangerouslySetInnerHTML={{ __html: htmlText }}
                        />:null}
                      </div>
                      <div className='previewEmailBody'>
                        {htmlTextBody ? <div
                          className="previewBodyStyle" 
                          dangerouslySetInnerHTML={{ __html: htmlTextBody }}
                        />:null}
