        ...
        <div className='bodyPoppup'>
          ...
          <div className='bodyPoppupR'>
            ...
            {(marketingTemplate==="whatsapp")?<> <div>
              <img src={whatsapp} alt='whatsappImg' className='selectImg'/>
            </div> 
            ...
            <div className='MobileScroll'>
             ...
             {(marketingTemplate==="platform")?<> <div>
              <img src={platform} alt='platformImg' className='selectImgs'/>
            </div> 
            <div className='MobileScroll'>
                <div className='MobileScreenSms'>
                  <div className='previewStylePlatform'>
                    {/* <div className='previewPlatformCont'>
                      <div className='platformMsgCont'>
                        <h5>"WATI" Wants to <br/> Use "google.com" to Sign In</h5>
                        <p>This allows the app and website to <br/> share information about you.</p>
                      </div>
                      <div className='platformMsgBtn'>
                        <div>
                          <p>Cancel</p>
                        </div>
             ...
             {(marketingTemplate==="push")?<> <div>
              <img src={push} alt='pushImg' className='selectImgs'/>
            </div> 
            <div className='MobileScroll'>
                <div className='MobileScreenSms'>
                  <div className='previewStylePush'>
                    { broadcast.value ==="media"&&selectOption === 'IMAGE' ? <div className='bg-img-div'>
                    <img src={filePreview ? filePreview:img} alt="Image" className="documentVdoImg"/>
                    </div> :null} 
             ...
             {(marketingTemplate==="email")?<> <div>
              <img src={email} alt='emailImg' className='selectImgs'/>
            </div> 
            <div className='MobileScroll'>
                <div className='MobileScreenSms'>
                  <div>
