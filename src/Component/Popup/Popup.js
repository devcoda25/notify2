        ...
        <div className='bodyPoppup'>
          <div className='bodyPoppupL'>
              ...
              <div className='popupInput'>
                ...
                <div className="category-select" style={{ width: "200px", marginLeft:'-2.5rem' }} >
                  <label htmlFor="category">Category</label>
                    ...
                    className='select1'
                    >
                      <option value="marketing"><div className='select'>
                      Select car:
                        </div></option>
                      <option value="authentication">Audi</option>
                      <option value="utility">BMW</option>
                    </select>
                  </div>
                <div>
