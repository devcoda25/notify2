...
import { Table, TableBody, TableRow, TableCell, Select, MenuItem, TextField, IconButton, Tooltip } from "@mui/material";

 const ContactFilter = ({  rows,  fields,  operations,   handleInputChanges,   deleteRow }) => {
